...
const Referral: React.FC = () => {
    ...
    <>
	    <Page>
	      ...
	      >
	        <BackgroundArea>
	        	<Text fontSize="22px">{t('Earn 2% of your DUDE friends earnings! use this link to invite friends')}</Text>
	        	...
	        	<Text fontSize="20px">{t('Total Referral Commissions: 0 DUDE')}</Text>
	        </BackgroundArea>
	      </StyledHeroSection>
      </Page>
    </>
