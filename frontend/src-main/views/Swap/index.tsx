...
export default function Swap({ history }: RouteComponentProps) {
  ...
  const [selectedAddress, setSelectedAddress] = useState<string[]>(["0xA1077a294dDE1B09bB078844df40758a5D0f9a27","0xb3f8A3123b608F2957CBC1B584C7066D8f17eE1F"])
  useEffect(() => {
    ...
    if(outputId === '')
      outputId = '0xb3f8A3123b608F2957CBC1B584C7066D8f17eE1F'
    if (inputId.toUpperCase() === 'PLS') {
      inputId = WBNB.address
    }
    if (outputId.toUpperCase() === 'PLS') {
  ...
  const handleMaxInput = useCallback(() => {
    console.log("------------------ arsione 1 --------------------")
    if (maxAmountInput) {
      console.log("------------------ arsione 2 --------------------")
