...
import { LiquidityCard, LiquidityCardBody, LiquidityCardHeader, LiquidityCardFooter } from "../../components/LiquidityCard";

it("renders correctly", () => {
  const { asFragment } = renderWithTheme(
    <LiquidityCard>
      <LiquidityCardHeader>Header</LiquidityCardHeader>
