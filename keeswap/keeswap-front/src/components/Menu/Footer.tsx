    ...
    <Wrapper>
      <Flex flexDirection={['column', 'column', 'row']} alignItems="center">
        <ButtonMenu variant="subtle" scale="sm" activeIndex={0}>
          ...
          <ButtonMenuItem as="a" href="https://v1exchange.keeswap.com/#/">
            {t('V1 (old)')}
          </ButtonMenuItem>
        </ButtonMenu>
        <LinkExternal
          id="ercBridge"
          href="https://www.binance.org/en/bridge?utm_source=rissotto"
          ml={[0, 0, '40px']}
          mt={['20px', '20px', 0]}
          mb={['8px', '8px', 0]}
        >
      ...
      >
        <BubbleWrapper>
          <Button
            ...
            as="a"
            external
            href="https://docs.rissot.to/products/rissotto-exchange"
            variant="subtle"
          >
            {t('Need help ?')}
          </Button>
