...
const Stats = () => {
  ...
  console.log('alex: priceCake = ', priceCake)
      ...
      <Flex flexDirection={['column', null, null, 'row']} justifyContent="space-between" width="100%">
        <IconCard>
          <ValueWrapper>
            <ValueArea mb="20px">
              <ValueItemArea>
                <ValueTitle>{t('KEE to Harvest')}</ValueTitle>
                <Value>{t('%collect%', { collect: numTotalToCollect.toFixed(3) })}</Value>
              </ValueItemArea>
              <ValueItemArea>
                <ValueTitle>{t('KEE to Wallet')}</ValueTitle>
