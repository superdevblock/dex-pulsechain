...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and KEE pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and KEE pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from KEE pool', data)
  }
