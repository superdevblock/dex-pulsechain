...
import TabMenu from '../Swap/components/TabMenu'
...
export default function Pool() {
  ...
  return (
    <Page>
      <AppBody>
        <AppHeader title={t('Remove liquidity to receive tokens back')} subtitle={t('Remove liquidity to receive tokens back')} />
        <Body>
          {renderBody()}
          {account && !v2IsLoading && (
